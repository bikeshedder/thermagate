...
pub enum ParamName {
    ...
    #[clap(name = "REFRIGERANT_TEMP")]
    RefrigerantTemp = 0xc103,
    #[serde(rename = "T_R")]
    #[clap(name = "T_R")]
    TR = 0xc104,
    #[serde(rename = "OUTDOOR_TEMP_OPT")]
    #[clap(name = "OUTDOOR_TEMP_OPT")]
